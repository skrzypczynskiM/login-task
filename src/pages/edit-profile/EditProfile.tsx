            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                <div className="md:col-span-5">
                  ...
                  <input
                    ...
                    className={classNames(
                      "block w-full px-4 mt-2 py-2 text-sm font-normal text-gray-700 bg-white bg-clip-padding border border-solid rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:outline-none",
                      {
                        "border-red-600": errors?.fullname,
                ...
                <div className="md:col-span-5">
                  ...
                  <input
                    ...
                    className={classNames(
                      "block w-full px-4 mt-2 py-2 text-sm font-normal text-gray-700 bg-white bg-clip-padding border border-solid rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:outline-none",
                      {
                        "border-red-600": errors?.profession,
                        "border-gray-300 focus:border-blue-600":
                          !errors?.profession,
                      }
                    )}
                ...
                <div className="md:col-span-2">
                  <label htmlFor="favouritePizza">Favourite pizza</label>
                  <select
                    ...
                    className={classNames(
                      "block w-full px-4 mt-2 py-2 text-sm font-normal text-gray-700 bg-white bg-clip-padding border border-solid rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:outline-none",
                      {
                        "border-red-600": errors?.favouritePizza,
                        "border-gray-300 focus:border-blue-600":
                          !errors?.favouritePizza,
                      }
                    )}
                  >
                    <option value={Pizza.Margherita}>Margherita</option>
                    <option value={Pizza.Pepperoni}>Pepperoni</option>
                    <option value={Pizza.Hawaiian}>Hawaiian</option>
                    <option value={Pizza.Buffalo}>Buffalo</option>
                  </select>
                ...
                <div className="md:col-span-3 md:ml-10">
                  <label className="block  mt-2 mb-2">Sex</label>
                  ...
                  <div className="text-red-600 h-3">{errors.sex?.message}</div>
                </div>
                <div className="md:col-span-5">
                  <label className="inline-flex items-center mt-3">
                    ...
                    />
                    <label className="ml-2 text-gray-700" htmlFor="consent">
